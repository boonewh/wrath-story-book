...
- **Still in the Blackwing Library** with the strike team (Caleth, Thane, Anevia, Aravashniel) and the four rescued librarians. Sitting on a fallen bookshelf, looking at his hands which are just hands again. **The party is split** — Horgus, Klarah, and Nageru are back at Gwerm Manor. No one has returned yet; how the strike team and the manor group get back together is a Session 5 problem.
- **Tomorrow (or whenever the next chapter opens):** the long walk to the Defender's Heart to meet Irabeth (Anevia's wife) — but first the reunion with Nageru/Horgus/Klarah at the manor
