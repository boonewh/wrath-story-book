...
- With the strike team inside the **Gray Garrison**, upper hallway, ground and second floors taken. Spent heavily on healing through a brutal night — wand and waves both — and is running thinner for it.
- **New primary weapon: the adamantine, enchanted First Crusade warhammer** recovered from the defiled museum. His old warhammer is set aside for it.
- **Carries a borrowed magic Iomedae sunburst shield** taken from the temple armory — held with respect until he can seek the gods' leave to bear it alongside Torag's hammer-and-anvil.
- Took demon-claws and a demon's foul bite (the foulness reached into him and **broke on his faith**), plus glaive-work across a long fight; closed his own and the others' wounds as grace allowed.
- Plate still dented from earlier sessions; the forge-repairs keep waiting.
- **Spent grace freely keeping Nageru alive** after the glaive went through his chest on the second floor — reached him through the cultists and would not let him stay down.
...
- That Thane and Anevia are Eagle Watch contract agents.
- The full identity of S. V.
