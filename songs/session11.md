...
[Intro]
(low drone, a single hammer on stone)
What comes home is small.
...
I thought that grief was all he left.
...
[Outro]
(drum and drone fall away to one low voice)
Let the demons learn.
Stone remembers.
So do we.
...
Character count: 897 (spaces included — under the 1,000 hard cap)

Slow, solemn dwarven ballad-anthem that builds into an oath. Around 64 BPM, funeral-march tempo, unhurried and heavy. Deep solo male voice, low and grave, weathered and close-mic'd — a dwarf's bass-baritone. Sparse percussion only: single hammer strikes on stone, an anvil ring, a deep taiko drum on the downbeat, a low sustained drone beneath. On each refrain a massed male choir joins in unison, adding weight and depth — never poppy harmony. Build ONLY in layers and intensity: more voices, more drum, more drone. Never change genre or tempo. Mood: somber, gravid, sacred, resolute — a funeral march becoming a vow. Deep cavern reverb, subterranean space. NO guitars, NO electric guitar, NO twang, NO rock drums, NO power metal, NO crash cymbals, NO pop, NO bright major-key swell, NO female vocals, NO synths. All-acoustic stone and voice, single register start to finish. Clean, heavy ending.

---

## Troubleshooting

1. **If it drifts to rock / guitar / twang (this project's #1 Suno failure):** Regenerate immediately. Reinforce `NO guitar, NO electric guitar, NO rock drums, all-acoustic stone and voice, hammer-on-anvil percussion and low drone only`. Keep it stone, drum, drone, and voices — never a band. If a guitar or twang shows up at all, discard the take.
2. **If the choir never triggers on the refrain:** The refrain must sound bigger than the verses by voices alone. Push `massed male choir enters in unison on the refrain, verses are one solo voice`. You can also cue it directly in the tag — `[Refrain - full male choir, unison]` — while keeping the verse tags bare so the contrast reads. If the whole song is choir front-to-back, strengthen the solo framing on the verses instead.
3. **If it drifts into power-metal / anthemic-rock / a triumphant major-key lift:** This is the most likely register failure — the "oath" energy tempts Suno toward stadium metal. Hold it down with `funeral-march tempo, minor/modal, somber and heavy, NO power metal, NO uplifting major-key swell, builds in weight not brightness`. The climax should get *heavier and lower*, not faster or shinier.
